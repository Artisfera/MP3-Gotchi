# MP3-Gotchi firmware v0.1.11

This is the MP3-Gotchi 0.1.11 raw progress firmware. It keeps the working YX5300 and MPU6050 pinouts, keeps logical YX5300 track mapping, adds simple 1-100 shake sensitivity control, uses software OLED brightness scaling, and keeps user-facing settings in one community-friendly file.
...
```powershell
.\.venv\Scripts\python.exe .\firmware\tools\generate_aseprite_mini_font.py --input C:\path\to\aseprite-mini.otf --output .\firmware\src\mp3gotchi-0.1.11\AsepriteMiniFontData.h --font-size 5
```
