...
void App::begin() {
  ...
  Serial.println(" Firmware v0.1.11");
  ...
  Serial.println(" Commands: pinout, brightness, shake, mpu diag, yx diag");
  Serial.println("==================================================");
  Serial.println();
...
void App::processSerialCommand(char* command) {
  ...
  if (strcmp(command, "pinout") == 0) {
    ...
    Serial.println("Unknown command. Use: pinout, brightness, brightness 0-100, shake, shake 1-100, mpu diag, yx diag.");
  }
}
