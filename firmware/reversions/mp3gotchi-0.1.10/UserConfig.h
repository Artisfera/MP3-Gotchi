...
namespace UserConfig {
  ...
  constexpr float SHAKE_ACCEL_TOTAL_G_THRESHOLD = 0.35f;
  constexpr float SHAKE_ACCEL_CHANGE_G_THRESHOLD = 0.16f;
  constexpr float SHAKE_GYRO_DPS_THRESHOLD = 110.0f;
