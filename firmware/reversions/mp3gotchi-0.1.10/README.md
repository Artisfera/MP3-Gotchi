# MP3-Gotchi firmware v0.1.10

This is the MP3-Gotchi 0.1.10 raw progress firmware. It keeps the working YX5300 and MPU6050 pinouts, adds logical YX5300 track mapping for the current module index offset, keeps user-generated emotes as generated sparse RGB565 assets, and keeps user-facing settings in one community-friendly file.
...
```powershell
.\.venv\Scripts\python.exe .\firmware\tools\generate_aseprite_mini_font.py --input C:\path\to\aseprite-mini.otf --output .\firmware\src\mp3gotchi-0.1.10\AsepriteMiniFontData.h --font-size 5
```
