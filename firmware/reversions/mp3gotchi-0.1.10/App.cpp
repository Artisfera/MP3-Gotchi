...
void App::begin() {
  ...
  Serial.println();
  Serial.println("MP3-Gotchi firmware v0.1.10");
  Serial.println("Code created with ChatGPT as programming assistant. Concept and hardware by Patryk Ankudowicz (Artisfera).");
  Serial.println("Commands: pinout, brightness, brightness 0-100, mpu diag, yx diag.");
...
void App::processSerialCommand(char* command) {
  ...
  if (strcmp(command, "pinout") == 0) {
    ...
    Serial.println("Unknown command. Use: pinout, brightness, brightness 0-100, mpu diag, yx diag.");
  }
}
