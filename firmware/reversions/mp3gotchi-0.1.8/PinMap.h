...
namespace Pins {
  ...
  constexpr uint8_t YX_RX_FROM_MODULE = 16; // ESP32 RX, connected to YX5300 TX.
  constexpr uint8_t YX_TX_TO_MODULE   = 17; // ESP32 TX, connected to YX5300 RX through 1k.
  ...
  constexpr uint8_t MPU_SDA = 5;
  constexpr uint8_t MPU_SCL = 15;
