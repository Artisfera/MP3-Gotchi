...
// MP3-Gotchi firmware v0.1.2 configuration.
...
namespace Config {
  ...
  constexpr float SHAKE_ACCEL_DELTA_THRESHOLD = 2.8f;  // m/s^2 above or below gravity.
  constexpr float SHAKE_ACCEL_CHANGE_THRESHOLD = 1.2f; // m/s^2 between sensor samples.
  constexpr float SHAKE_GYRO_THRESHOLD = 1.6f;         // rad/s combined rotation.
  constexpr unsigned long SHAKE_COOLDOWN_MS = 450;
